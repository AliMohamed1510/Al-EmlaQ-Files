...
const translations = {
    ar: {
        ...
        'passport_info': 'بيانات جواز السفر',
        'contact_info': 'بيانات الاتصال',
        'travel_info': 'بيانات السفر',
        'employment_info': 'بيانات العمل / الدراسة',
        'financial_info': 'المصاريف والتمويل',
        'spouse_info': 'بيانات الزوج/الزوجة (إن وجد)',
        'surname': 'اللقب (بالإنجليزية)',
        'first_name': 'الاسم (بالإنجليزية)',
        'surname_birth': 'اللقب عند الولادة (إن وجد)',
        'dob': 'تاريخ الميلاد',
        'pob': 'مكان الولادة',
        'cob': 'دولة الولادة',
        'nationality': 'الجنسية الحالية',
        'sex': 'الجنس',
        'male': 'ذكر',
        'female': 'أنثى',
        ...
        'passport_issued': 'جهة الإصدار',
        'passport_issue_date': 'تاريخ الإصدار',
        'passport_expiry': 'تاريخ الانتهاء',
        'home_address': 'العنوان الحالي',
        'email': 'البريد الإلكتروني',
        'phone': 'رقم الهاتف',
        'main_destination': 'دولة الوجهة الرئيسية',
        'first_entry': 'دولة الدخول الأولى',
        'entries_type': 'نوع الدخول',
        'single_entry': 'دخول واحد',
        'double_entry': 'دخولين',
        'multiple_entry': 'متعدد',
        'travel_purpose': 'الغرض من السفر',
        'purpose_tourism': 'سياحة',
        'purpose_business': 'عمل',
        'purpose_study': 'دراسة',
        'purpose_family': 'زيارة عائلية',
        'purpose_medical': 'علاج',
        'purpose_other': 'أخرى',
        'duration': 'مدة الإقامة (يوم)',
        'occupation': 'المهنة الحالية',
        'employer': 'جهة العمل / الدراسة',
        'employer_address': 'عنوان جهة العمل / الدراسة',
        'means_support': 'مصدر تمويل الرحلة',
        'self_funded': 'نفسي',
        'sponsor': 'كفيل/ضامن',
        'employer_funded': 'جهة العمل',
        'family_funded': 'العائلة',
        'sponsor_name': 'اسم الكفيل (إن وجد)',
        'spouse_surname': 'لقب الزوج/الزوجة',
        'spouse_name': 'اسم الزوج/الزوجة',
        'spouse_dob': 'تاريخ ميلاد الزوج/الزوجة',
    ...
    en: {
        ...
        'employment_info': 'Employment / Study',
        'financial_info': 'Expenses & Funding',
        'spouse_info': 'Spouse Information (if applicable)',
        'surname': 'Surname (English)',
        'first_name': 'First Name(s) (English)',
        'surname_birth': 'Surname at Birth (if different)',
        'dob': 'Date of Birth',
        'pob': 'Place of Birth',
        ...
        'passport_issued': 'Issued By',
        'passport_issue_date': 'Date of Issue',
        'passport_expiry': 'Valid Until',
        'home_address': 'Home Address',
        'email': 'Email Address',
        'phone': 'Phone Number',
        'main_destination': 'Main Destination',
        'first_entry': 'First Entry Country',
        'entries_type': 'Type of Entry',
        ...
        'purpose_study': 'Study',
        'purpose_family': 'Family Visit',
        'purpose_medical': 'Medical',
        'purpose_other': 'Other',
        'duration': 'Duration of Stay (days)',
        'occupation': 'Current Occupation',
        'employer': 'Employer / School',
        'employer_address': 'Employer / School Address',
        'means_support': 'Means of Support',
        'self_funded': 'Self-funded',
        'sponsor': 'Sponsor',
        'employer_funded': 'Employer',
        'family_funded': 'Family',
        'sponsor_name': 'Sponsor Name (if applicable)',
        'spouse_surname': 'Spouse Surname',
        'spouse_name': 'Spouse First Name',
